...
- vscode에서 자동 추출
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/5bee79f2-c6fb-4eb0-881d-38eebf165298/Untitled.png)
...
<aside>
👉 지역 변수를 제거하면 추출 작업 쉬워짐

추출작업 전에는 항상 지역 변수부터 제거할 것
...
<aside>
👉 리팩터링 중간에 테스트 실패하고 원인을 바로 찾지 못하면?
→ 가장 최근 커밋으로 돌아가서 실패한 리팩터링 단계를 더 작게 나눠 다시 시도
